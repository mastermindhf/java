...
public class User {
   ...
   private static final Map<Integer, User> USERS = new HashMap<>();
    ...
    public User(int id, String username, String username_canonical, String email, String email_canonical, String password, int enabled, String roles, String nom, String prenom, String phone) {
        this.id = id;
        this.username = username;
        this.username_canonical = username_canonical;
        this.email = email;
